      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
            ...
            <td><?php foreach ($languages as $language) { ?>
              <input type="textarea" name="attribute_description[<?php echo $language['language_id']; ?>][description]" value="<?php echo isset($attribute_description[$language['language_id']]['description']) ? $attribute_description[$language['language_id']]['description'] : ''; ?>" />
              <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /><br />
              <?php } ?></td>
          </tr>          
          <tr>
