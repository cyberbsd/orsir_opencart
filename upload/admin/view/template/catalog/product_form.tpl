      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
              <td><?php echo $entry_subtract_weight; ?></td>
              <td><?php if ($subtract_weight) { ?>
                <input type="radio" name="subtract_weight" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="subtract_weight" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="subtract_weight" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="subtract_weight" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>            
            <tr>
            ...
            <table id="option-value<?php echo $option_row; ?>" class="list">
              <thead>
                <tr>
                  ...
                  <td class="left"><?php echo $entry_subtract_rate; ?></td>
              ...
              <tbody id="option-value-row<?php echo $option_value_row; ?>">
                <tr>
                  ...
                  <td class="right">
                    <input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][subtract_rate]" value="<?php echo $product_option_value['subtract_rate']; ?>" size="3" />
                  </td>                  
...
function attributeautocomplete(attribute_row) {
	$('input[name=\'product_attribute[' + attribute_row + '][name]\']').catcomplete({
		...
		select: function(event, ui) {
			...
			$('textarea[name=\'product_attribute[' + attribute_row + '][product_attribute_description][<?php echo $language['language_id']; ?>][text]\']').text(ui.item.description);			
