        ...
        <div id="tab-general">
          ...
          <div id="tab-customer" class="vtabs-content">
            <table class="form">
              ...
              <tr>
                <td><?php echo $entry_telephone2; ?></td>
                <td><input type="text" name="telephone2" value="<?php echo $telephone2; ?>" />
                  <?php if ($error_telephone2) { ?>
                  <span class="error"><?php echo $error_telephone2; ?></span>
                  <?php  } ?></td>
              </tr>
              <tr>
                <td><?php echo $entry_telephone3; ?></td>
                <td><input type="text" name="telephone3" value="<?php echo $telephone3; ?>" />
                  <?php if ($error_telephone3) { ?>
                  <span class="error"><?php echo $error_telephone3; ?></span>
                  <?php  } ?></td>
              </tr>              
              <tr>
              ...
              <tr>
                ...
                <td><input type="text" name="vat" value="<?php echo $vat; ?>" />
                  <?php if ($error_vat) { ?>
                  <span class="error"><?php echo $error_vat; ?></span>
                  <?php  } ?></td>
              </tr>  
              <tr>
                <td><?php echo $entry_vat_title; ?></td>
                <td><input type="text" name="vat_title" value="<?php echo $vat_title; ?>" />
                  <?php if ($error_vat_title) { ?>
                  <span class="error"><?php echo $error_vat_title; ?></span>
                  <?php  } ?></td>
              </tr>                          
              <tr>
              ...
              <tr>
                <td><?php echo $entry_oversea; ?></td>
                <td><select name="oversea">
                    <?php if ($oversea) { ?>
                    <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                    <option value="0"><?php echo $text_disabled; ?></option>
                    <?php } else { ?>
              ...
              <tr>
                ...
                <td><textarea name="note" rows=3 cols=40><?php echo $note; ?></textarea></td>
              </tr>         
              <tr>
                <td><?php echo $entry_birth; ?></td>
                <td><input type="text" name="birth" value="<?php echo $birth; ?>" />
                  <?php if ($error_birth) { ?>
                  <span class="error"><?php echo $error_birth; ?></span>
                  <?php  } ?></td>
              </tr>                                                      
              <tr>
          ...
          <div id="tab-address-<?php echo $address_row; ?>" class="vtabs-content">
            ...
            <table class="form">
              ...
              <tr>
                ...
                <td><input type="text" name="address[<?php echo $address_row; ?>][address_3]" value="<?php echo $address['address_3']; ?>" /></td>
              </tr>              
              <tr>
