...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$this->data['entry_subtract_weight'] = $this->language->get('entry_subtract_weight');
		$this->data['entry_subtract_rate'] = $this->language->get('entry_subtract_rate');
	  ...
	  if (isset($this->request->post['subtract_weight']) &&
	      (isset($this->data['subtract_weight']) && $this->data['subtract_weight'] == 0 ) )
	  {
			$this->data['subtract_weight'] = $this->request->post['subtract_weight'];
		} elseif (!empty($product_info)) {
			$this->data['subtract_weight'] = $product_info['subtract_weight'];
		} else {
			$this->data['subtract_weight'] = 0;
		}
