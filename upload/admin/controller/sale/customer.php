...
class ControllerSaleCustomer extends Controller {
	...
	protected function getForm() {
		...
		$this->data['entry_telephone3'] = $this->language->get('entry_telephone3');
		$this->data['entry_vat'] = $this->language->get('entry_vat');
		$this->data['entry_vat_title'] = $this->language->get('entry_vat_title');
		$this->data['entry_birth'] = $this->language->get('entry_birth');
		$this->data['entry_fax'] = $this->language->get('entry_fax');
		$this->data['entry_ent'] = $this->language->get('entry_ent');
		$this->data['entry_oversea'] = $this->language->get('entry_oversea');
		$this->data['entry_hundred'] = $this->language->get('entry_hundred');
		...
		if (isset($this->error['telephone2'])) {
			$this->data['error_telephone2'] = $this->error['telephone'];
		} else {
			$this->data['error_telephone2'] = '';
		}

		if (isset($this->error['telephone3'])) {
			$this->data['error_telephone3'] = $this->error['telephone3'];
		} else {
			$this->data['error_telephone3'] = '';
		}

		if (isset($this->error['vat'])) {
			$this->data['error_vat'] = $this->error['vat'];
		} else {
			$this->data['error_vat'] = '';
		}

		if (isset($this->error['vat_title'])) {
			$this->data['error_vat_title'] = $this->error['vat_title'];
		} else {
			$this->data['error_vat_title'] = '';
		}

		if (isset($this->error['birth'])) {
			$this->data['error_birth'] = $this->error['birth'];
		} else {
			$this->data['error_birth'] = '';
		}

	  if (isset($this->error['ent'])) {
			$this->data['error_ent'] = $this->error['ent'];
		} else {
			$this->data['error_ent'] = '';
		}

		if (isset($this->error['oversea'])) {
			$this->data['error_oversea'] = $this->error['oversea'];
		} else {
			$this->data['error_oversea'] = '';
		}

	  if (isset($this->error['hundred'])) {
			$this->data['error_hundred'] = $this->error['hundred'];
		} else {
			$this->data['error_hundred'] = '';
		}

		if (isset($this->error['note'])) {
			$this->data['error_note'] = $this->error['note'];
		} else {
			$this->data['error_note'] = '';
		}
		...
		if (isset($this->request->post['telephone3'])) {
			$this->data['telephone3'] = $this->request->post['telephone3'];
		} elseif (!empty($customer_info)) {
			$this->data['telephone3'] = $customer_info['telephone3'];
		} else {
			$this->data['telephone3'] = '';
		}
		...
		if (isset($this->request->post['vat_title'])) {
			$this->data['vat_title'] = $this->request->post['vat_title'];
		} elseif (!empty($customer_info)) {
			$this->data['vat_title'] = $customer_info['vat_title'];
		} else {
			$this->data['vat_title'] = '';
		}
		...
		if (isset($this->request->post['ent'])) {
			$this->data['ent'] = $this->request->post['ent'];
		} elseif (!empty($customer_info)) {
			$this->data['ent'] = $customer_info['ent'];
		} else {
			$this->data['ent'] = '';
		}

		if (isset($this->request->post['oversea'])) {
			$this->data['oversea'] = $this->request->post['oversea'];
		} elseif (!empty($customer_info)) {
			$this->data['oversea'] = $customer_info['oversea'];
		} else {
			$this->data['oversea'] = '';
		}

		if (isset($this->request->post['hundred'])) {
			$this->data['hundred'] = $this->request->post['hundred'];
		} elseif (!empty($customer_info)) {
			$this->data['hundred'] = $customer_info['hundred'];
		} else {
			$this->data['hundred'] = '';
		}
