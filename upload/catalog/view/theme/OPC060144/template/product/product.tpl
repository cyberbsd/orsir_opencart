		 ...
		 <div class="additional-carousel">	
		  ...
		  <div class="slider-item">
				<div class="product-block">		
        			<a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class="elevatezoom-gallery" data-image="<?php echo $thumb; ?>" data-zoom-image="<?php echo $popup; ?>"><img id="cloud-zoom" src="<?php echo $thumb; ?>" width="74" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a>
				</div>
				</div>	
  ...
  <div id="products-related" class="related-products">
	...
	<div class="box-product <?php if ($productCount >= $sliderFor){?>product-carousel<?php }else{?>productbox-grid<?php }?>" id="<?php if ($productCount >= $sliderFor){?>related-carousel<?php }else{?>related-grid<?php }?>">
	  ...
	  <div class="product-block-inner">
        ...
        <a onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button" title="<?php echo $button_cart; ?>"><?php echo $button_cart; ?></a>
		<a href="<?php echo $product['href']; ?>" class="view" title="Quick View">&nbsp;</a>
