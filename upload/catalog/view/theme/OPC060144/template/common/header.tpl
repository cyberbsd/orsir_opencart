...
<div class="header_top">
		...
		<div class="tm_headerlinkmenu">
				...
				<li><a href="<?php echo $wishlist; ?>" id="wishlist-total1"><?php echo $text_wishlist; ?></a></li>
				</ul> 
		</div>
		<div class="links">												
...
<div class="nav-responsive"><span>Menu</span><div class="expandable"></div></div>
  ...
  <li class="level0"><a href="<?php echo $home; ?>"><?php echo $text_home; ?></a></li>
   <?php $r=0; foreach ($categories as $category) {$r++;} ?>
       <?php $k=0; foreach ($categories as $category) {$k++; ?>
    <li class=" level0 <?php if($r == $k ){echo "last";} ?> "><a href="<?php echo $category['href']; ?>"><?php echo $category['name']; ?></a>
