      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
			...
			<span class="span_image"><?php echo $column_image; ?></span>
              <a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" /></a>
              <?php } ?></td>
            <td class="name">
			 <span class="span_name"><?php echo $column_name; ?></span>
			<a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
              ...
              <?php } ?></td>
            <td class="model"><span class="span_model"><?php echo $column_model; ?></span><?php echo $product['model']; ?></td>
            <td class="quantity"><span class="span_quantity"><?php echo $column_quantity; ?></span>
            ...
            <td class="price"><span class="span_price"><?php echo $column_price; ?></span><?php echo $product['price']; ?></td>
            <td class="total"><span class="span_total"><?php echo $column_total; ?></span><?php echo $product['total']; ?></td>
          </tr>
          <?php } ?>
